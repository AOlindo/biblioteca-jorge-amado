...
public class ResourceExceptionHandlerr {
	...
	public ResponseEntity<Error> file(FileException e, HttpServletRequest request) {
		Error erro = new Error(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erro de arquivo",
				e.getMessage(), request.getRequestURI());
	...
	public ResponseEntity<Error> file(RegraNegocioException e, HttpServletRequest request) {
		Error erro = new Error(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Error de regra de negócio",
				e.getMessage(), request.getRequestURI());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(erro);
	...
	public ResponseEntity<Error> amazonService(AmazonServiceException e, HttpServletRequest request) {
		...
		Error erro = new Error(System.currentTimeMillis(), code.value(), "Erro Amazon Service", e.getMessage(),
	...
	public ResponseEntity<Error> internalServerErrorException(InternalServerErrorException e,
			HttpServletRequest request) {
		Error erro = new Error(System.currentTimeMillis(), HttpStatus.INTERNAL_SERVER_ERROR.value(), "Erro interno",
				e.getMessage(), request.getRequestURI());
	...
	public ResponseEntity<Error> amazonClient(AmazonClientException e, HttpServletRequest request) {
		Error erro = new Error(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erro Amazon Client",
				e.getMessage(), request.getRequestURI());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(erro);
	...
	public ResponseEntity<Error> amazonS3(AmazonS3Exception e, HttpServletRequest request) {
		Error erro = new Error(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erro S3", e.getMessage(),
				request.getRequestURI());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(erro);
